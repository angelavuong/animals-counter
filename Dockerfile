...
ADD http://nexus-openshift-operators.apps.cluster-25l4w.25l4w.sandbox1575.opentlc.com/repository/maven-snapshots/com/aliction/animals-counter-springboot/0.0.1-SNAPSHOT/animals-counter-springboot-0.0.1-20220324.204441-1.jar /deployments/application.jar
#ADD animals-counter-springboot/target/animals-counter-springboot-0.0.1-SNAPSHOT.jar /deployments/application.jar
chmod +x /deployments/application.jar
WORKDIR /deployments
EXPOSE 8080
